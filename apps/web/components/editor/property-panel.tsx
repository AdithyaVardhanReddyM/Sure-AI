...
interface PropertyPanelProps {
  element: ElementData;
  onUpdate: (updated: ElementData) => void;
}
...
export default function PropertyPanel({
      ...
      <div className="p-4 space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            column{element.numOfCol && element.numOfCol > 1 ? "s" : ""}.
          </p>
  ...
  const handleOuterStyleChange = (
    property: keyof OuterStyle,
    value: string | number
  ) => {
    const updatedElement: ElementData = {
      ...element,
  ...
  const handleContentChange = (property: keyof ElementData, value: any) => {
    const updatedElement: ElementData = {
      ...element,
      [property]: value,
    };
            ...
            <div>
              ...
              <div className="flex gap-2 items-center">
                <Input
                  type="number"
                  value={parseInt(
                    element.style.paddingLeft || element.style.padding || "10"
                  )}
                  onChange={(e) => {
            ...
            <div>
              ...
              <div className="flex gap-2 items-center">
                <Input
                  type="number"
                  value={parseInt(
                    element.style.paddingTop || element.style.padding || "10"
                  )}
                  onChange={(e) => {
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2 items-center">
            ...
            <input
              ...
              min="10"
              max="100"
              value={parseInt(String(element.style.width) || "50")}
              onChange={(e) => handleStyleChange("width", `${e.target.value}%`)}
              className="flex-1"
            />
          </div>
      ...
      {element.style &&
        Object.keys(element.style).map((key) => (
          <div key={key} className="space-y-2">
            ...
            <Input
              value={(element.style as any)[key]}
              onChange={(e) =>
                handleStyleChange(key as keyof ElementStyle, e.target.value)
              }
            />
          </div>
        ))}
